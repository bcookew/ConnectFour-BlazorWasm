namespace ConnectFour_BlazorWasm.Services
{
    public class GameState
    {
        ...
        public static void CalculateWinningPlaces()
        {
            ...
            for (byte row = 0; row<6; row++)
            {
                ...
                byte rowCol1 = (byte)(row * 7); // ex 0 * 7 = 0 Start index of first row
                byte rowColEnd = (byte)((row + 1) * 7 - 1); // (0 + 1) * 7 - 1 = 6 end index of first row
                byte checkCol = rowCol1; // checkCol = 0
                while (checkCol <= rowColEnd-3) // <= 3
                {
                    ...
                    (byte)(checkCol + 2),
                    (byte)(checkCol + 3)
                    }); // [0, 1, 2, 3] a winning set represented as an array of indexes
                    checkCol++;
                }
